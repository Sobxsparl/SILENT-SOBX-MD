...
const ownerNumber = ['923251869133']
...
console.log("CONNECTING SOBX-MD BOT🧬...");
...
console.log('SOBX-MD CONNECTED TO WHATSAPP ENJOY ✅')
...
*╭⊱✫🔮 SOBX-MD 🔮✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *SOBX-MD*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *SOBIA BUTT133*
*│✫➠ - 🌐URL:* *https://github.com/SILENTLOVER40/SOBIA-BUTT-MD*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://shttps://files.catbox.moe/mm3s08.jpg` }, caption: up })
